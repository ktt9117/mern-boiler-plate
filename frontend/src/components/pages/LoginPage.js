...
function LoginPage() {
  ...
  useEffect(() => {
    if (cookies.checkRemember && cookies.rememberEmail) {
        ...
        <Grid item xs={12} sm={8} md={5} component={Paper} elevation={6} square>
          ...
          >
            ...
            <Box component="form" noValidate onSubmit={handleSubmit} sx={{ mt: 1 }}>
              ...
              />
              <FormControlLabel control={<Checkbox value={checkRemember} color="primary" />} label="Remember me" />
